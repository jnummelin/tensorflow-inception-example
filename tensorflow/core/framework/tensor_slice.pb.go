...
func (*TensorSliceProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func (*TensorSliceProto_Extent) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0, 0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/tensor_slice.proto", fileDescriptor20) }
